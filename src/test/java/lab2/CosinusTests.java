...
public class CosinusTests extends Assert {
    /*
     * Hash Maps: key - input, value - result.
     */
    private static final double delta = 0.001;
    public static IMyMath myMath = new MyTestBaseMath();
    ...
    void testFunction(double testValue) {
        double actual = myMath.cos(testValue, delta);
        double expected = Math.cos(testValue);

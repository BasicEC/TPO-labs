...
public class TrigTest extends Assert {
    /*
     * Hash Maps: key - input, value - result.
     */
    private static final double delta = 0.001;
    static final int deltaPow = 4;
    static final IMyMath myMath = new MyMath();
    ...
    public static Collection<Object[]> TestData() {
        IMathFunc myTan = (x) -> testMath.tan(x, deltaPow);
        IMathFunc expectTan = Math::tan;

        IMathFunc mySec = (x) -> myMath.sec(x, deltaPow);
        IMathFunc expectSec = (x) -> 1 / Math.cos(x);

        Object[][] data = new Object[][]{{myTan, expectTan}, {mySec, expectSec}};

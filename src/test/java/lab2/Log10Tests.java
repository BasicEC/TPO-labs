...
public class Log10Tests extends Assert {
    private static final double delta = 0.001;
    private static final IMyMath myMath = new MyTestBaseMath();
    ...
    private void testFunction(double testValue){
        double expected = Math.log(testValue) / Math.log(10);
        double actual = myMath.log10(testValue, delta);
